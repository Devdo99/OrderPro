...
export default function TableCard({ table }: TableCardProps) {
  ...
  // PERBAIKAN: Logika klik disederhanakan dan dipindahkan ke sini
  const handleClick = () => {
    // Hanya jika bisa diklik (status 'available'), arahkan ke halaman pemesanan
    if (isClickable) {
  ...
  return (
    // Membungkus kartu dengan div yang bisa diklik
